...
const DICT: Record<string, Entry> = {
  ...
  'bank.poemHymn': { ru: 'Стихи и гимны', en: 'Poems & hymns', es: 'Poemas e himnos', de: 'Gedichte & Hymnen', fr: 'Poèmes et hymnes', it: 'Poesie e inni', pt: 'Poemas e hinos' },
  ...
  'bank.poemHymn.desc': { ru: 'Стихи и гимны по строфам (4–8 строк) — ритм и выносливость печати.', en: 'Poems & hymns by stanza (4–8 lines) — rhythm and stamina.', es: 'Poemas por estrofa (4–8 líneas) — ritmo y resistencia.', de: 'Gedichte je Strophe (4–8 Zeilen) — Rhythmus und Ausdauer.', fr: 'Poèmes par strophe (4–8 lignes) — rythme et endurance.', it: 'Poesie per strofa (4–8 righe) — ritmo e resistenza.', pt: 'Poemas por estrofe (4–8 linhas) — ritmo e resistência.' },
  // тулбар
