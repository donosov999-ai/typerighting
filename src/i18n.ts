...
const DICT: Record<string, { ru: string; en: string }> = {
  ...
  'comp.alpha_fwd': { ru: 'Алфавит А→Я', en: 'Alphabet A→Z' },
  'comp.alpha_rev': { ru: 'Алфавит Я→А', en: 'Alphabet Z→A' },
  'comp.words': { ru: 'Слова', en: 'Words' },
  'comp.digits': { ru: 'Цифры', en: 'Numbers' },
  'comp.sprint': { ru: 'Спринт', en: 'Sprint' },
  'comp.best': { ru: 'рекорд', en: 'best' },
  'comp.hint': { ru: 'на скорость, без ошибок', en: 'for speed, no errors' },
  'comp.record': { ru: 'Новый личный рекорд!', en: 'New personal record!' },
  'comp.name': { ru: 'Имя для таблицы', en: 'Name for the board' },
  'comp.publish': { ru: 'Опубликовать', en: 'Publish' },
  'comp.leaderboard': { ru: 'Таблица рекордов', en: 'Leaderboard' },
  'comp.player': { ru: 'Игрок', en: 'Player' },
  'comp.loading': { ru: 'Загрузка таблицы…', en: 'Loading board…' },
  'comp.empty': { ru: 'Пока нет результатов — будь первым!', en: 'No results yet — be the first!' },
  // AI-режим
